...
const AudioFileDropZone = ({
  classes, uploadRequest, uploadReject
}) => (
  <Dropzone
    className={classes.root}
    accept="audio/*"
    acceptStyle={{ background: '#eee' }}
  ...
  >
    <div className={classes.contents}>
      <Typography
        ...
        gutterBottom
      >
        Drag & drop an audio file to import, or browse.
      </Typography>
...
export default withStyles(styles)(connect(null, { uploadRequest, uploadReject })(AudioFileDropZone));
